...
runScript = QMessageBox.question(iface.mainWindow(), 'Run Script', 'Would you like to run Habitat Analyzer?', QMessageBox.Yes, QMessageBox.No)

if runScript == QMessageBox.Yes:
    QMessageBox.information(iface.mainWindow(), "Welcome to ScriptName", "Welcome")
    ...
    QMessageBox.information(iface.mainWindow(), "File Select", "Select your autobahn shapefile")
    ...
    QMessageBox.information(iface.mainWindow(), "End", "Terminating")
